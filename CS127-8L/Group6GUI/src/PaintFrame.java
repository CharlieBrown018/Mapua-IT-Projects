...
public class PaintFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 190, 820, 460));
        ...
        getContentPane().add(home, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 40, -1, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Frames/Paint_LM.png"))); // NOI18N
    ...
    private void musicButtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_musicButtActionPerformed
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                msc.setVisible(true);
                PaintFrame.this.setVisible(false);
