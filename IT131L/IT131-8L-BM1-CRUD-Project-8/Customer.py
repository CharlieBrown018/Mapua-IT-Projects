...
class ConnectorDB:
    ...
    def __init__(self,root):
        self.root = root
        titlespace = " "
        self.root.title(0 * titlespace + "Xialan Shaomai Customers Database GUI")
        self.root.geometry("1375x870+20+0")
        ...
        RightFrame1 = Frame(TopFrame3, bd = 5, width = 800, height = 100, padx = 2, pady = 4, bg = 'cadet blue')
        ...
        def GoToOrdered():
            iExit = tkinter.messagebox.askyesno("Xialan Shaomai Customer Database GUI", "Confirm if you want to go to Orders")
            if iExit > 0:
                root.destroy()
        ...
        def GoToProduct():
            iExit = tkinter.messagebox.askyesno("Xialan Shaomai Customer Database GUI", "Confirm if you want to go to Products")
            if iExit > 0:
                root.destroy()
        ...
        def GoToTransaction():
            iExit = tkinter.messagebox.askyesno("Xialan Shaomai Customer Database GUI", "Confirm if you want to go to Transactions")
            if iExit > 0:
                root.destroy()
        ...
        self.btnCustomer = Button(titlespace, font = ('arial', 20, 'bold'), text = "Customers", bd = 4, pady = 1, padx = 10,
                                width = 15, height = 2).grid(row = 1, column = 0, padx = 20)
