...
class ConnectorDB:
    ...
    def __init__(self,root):
        self.root = root
        titlespace = " "
        self.root.title(0 * titlespace + "Xialan Shaomai Orders Database GUI")
        self.root.geometry("1400x905+100+0")
        ...
        def iExit():
            iExit = tkinter.messagebox.askyesno("Xialan Shaomai Orders Database GUI", "Confirm if you want to exit")
            if iExit > 0:
                root.destroy()
                return
        ...
        def addData():
            if Ord_ID.get() =="" or C_ID.get() =="" or Prod_ID.get() =="" or Ord_Qty.get() =="" or Ord_Cost.get() =="" or Date_Ord.get() =="" or Trans_ID.get() =="":
                tkinter.messagebox.askyesno("Xialan Shaomai Orders Database GUI", "Enter Correct Details")
            else:
        ...
        def Update():
            ...
            sqlCon.commit()
            sqlCon.close()
            tkinter.messagebox.showinfo("Xialan Shaomai Orders Database GUI", "Record Updated Successfully")
        ...
        def DeleteDB():
            ...
            sqlCon.commit()
            sqlCon.close()
            tkinter.messagebox.showinfo("Xialan Shaomai Orders Database GUI", "Record Deleted Successfully")
            Reset()
        ...
        def SearchDB():
            try:
                ...
                tkinter.messagebox.showinfo("Xialan Shaomai Orders Database GUI", "No Such Record Found")
                Reset()
            sqlCon.close()


        def GoToCustomer():
            iExit = tkinter.messagebox.askyesno("Xialan Shaomai Orders Database GUI", "Confirm if you want to go to Customers")
            if iExit > 0:
                root.destroy()
        ...
        def GoToOrdered():
            iExit = tkinter.messagebox.askyesno("Xialan Shaomai Orders Database GUI", "Confirm if you want to go to Orders")
            if iExit > 0:
                root.destroy()
        ...
        def GoToProduct():
            iExit = tkinter.messagebox.askyesno("Xialan Shaomai Orders Database GUI", "Confirm if you want to go to Products")
            if iExit > 0:
                root.destroy()
        ...
        def GoToTransaction():
            iExit = tkinter.messagebox.askyesno("Xialan Shaomai Orders Database GUI", "Confirm if you want to go to Transactions")
            if iExit > 0:
                root.destroy()
        ...
        self.btnOrdered = Button(titlespace, font = ('arial', 20, 'bold'), text = "Orders", bd = 4, pady = 1, padx = 10,
                                width = 15, height = 2).grid(row = 1, column = 1, padx = 20)
