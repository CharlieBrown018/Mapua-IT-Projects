...
import com.journfitness.RecordEditorDialogbox;
...
import com.journfitness.utils.OnCustomEventListener;
...
public class RecordArrayAdapter extends ArrayAdapter {
    ...
    private void launchCountdown(Record record, ViewHolder viewHolder) {
        if (record.getTemplateRestTime() > 0) {
            ...
            CountdownDialogbox cdd = null;
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
                cdd = new CountdownDialogbox(mActivity, record.getTemplateRestTime(), lMachine);
            }
            // Launch Countdown
