...
public class ProgramHistoryCursorAdapter extends CursorAdapter implements Filterable {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        // Get Program Name
        @SuppressLint("Range") long historyKey = cursor.getLong(cursor.getColumnIndex(DAOProgramHistory.KEY));

        @SuppressLint("Range") long programKey = cursor.getLong(cursor.getColumnIndex(DAOProgramHistory.PROGRAM_KEY));
        Program program = daoProgram.get(programKey);

        // Get program Status
        @SuppressLint("Range") int programStatus = cursor.getInt(cursor.getColumnIndex(DAOProgramHistory.STATUS));
