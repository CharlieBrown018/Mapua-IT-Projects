...
import com.journfitness.DAO.DAOMachine;
import com.journfitness.DAO.DAOProfile;
import com.journfitness.DAO.DatabaseHelper;
import com.journfitness.DAO.Machine;
import com.journfitness.DAO.Profile;
import com.journfitness.DAO.cardio.DAOOldCardio;
import com.journfitness.DAO.cardio.OldCardio;
import com.journfitness.DAO.export.CVSManager;
import com.journfitness.DAO.program.DAOProgram;
import com.journfitness.DAO.program.Program;
import com.journfitness.DAO.record.DAOCardio;
import com.journfitness.DAO.record.DAOFonte;
import com.journfitness.DAO.record.DAORecord;
import com.journfitness.DAO.record.DAOStatic;
import com.journfitness.DAO.record.Record;
import com.journfitness.bodymeasures.BodyPartListFragment;
import com.journfitness.enums.DistanceUnit;
import com.journfitness.enums.ExerciseType;
import com.journfitness.enums.WeightUnit;
import com.journfitness.fonte.FontesPagerFragment;
import com.journfitness.intro.MainIntroActivity;
import com.journfitness.machines.MachineFragment;
import com.journfitness.programs.ProgramListFragment;
import com.journfitness.utils.DateConverter;
import com.journfitness.utils.ImageUtil;
import com.journfitness.utils.MusicController;
import com.journfitness.utils.UnitConverter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private boolean migrateToScopedStorage() {
        ...
        File folder = new File(Environment.getExternalStorageDirectory() + "/journfitplus");
    ...
    private void openExportDatabaseDialog(String autoExportMessage) {
        ...
        exportDbBuilder.setPositiveButton(getActivity().getResources().getText(R.string.global_yes), (dialog, which) -> {
            ...
            Date date = new Date();
            String folderName = Environment.DIRECTORY_DOWNLOADS + "/journfitplus/export/" +  dateFormat.format(date);
