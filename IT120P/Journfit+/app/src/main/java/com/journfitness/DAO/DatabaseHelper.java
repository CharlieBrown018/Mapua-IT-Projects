...
import com.journfitness.DAO.program.DAOProgramHistory;
...
import com.journfitness.enums.Muscle;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String OLD09_DATABASE_NAME = "journfitplus";
    public static final String DATABASE_NAME = "journfitplus.db";
        ...
        while (upgradeTo <= newVersion) {
            switch (upgradeTo) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    if (!FieldExists(db, DAOMachine.TABLE_NAME, DAOMachine.BODYPARTS)) // journfitplus 0.9 : Probleme d'upgrade
                ...
                case 10:
                    ...
                    break;
                case 11: // journfitplus 0.13.3 - Changed Poids from Integer to Real
